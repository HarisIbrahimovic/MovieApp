...
object LifeCycleModule {
    ...
    @Provides
    fun provideRatingRepository(firebaseAuth: FirebaseAuth):RatingRepository = DefaultRatingRepository(firebaseAuth)
    ...
    @Provides
    fun provideDetailsActorRepository(apiService: ApiService,actorDao: ActorDao,actorMovieCreditsDao: ActorMovieCreditsDao):DetailsActorRepository = DefaultDetailsActorRepository(apiService,actorDao,actorMovieCreditsDao)

    @Provides
    fun provideTvDetailsRepository(apiService: ApiService, tvDetailsDao: TvDetailsDao, castDao: CastDao,):DetailsTvRepository = DefaultTvDetailsRepository(apiService,tvDetailsDao, castDao)
