...
class GenreAdapter(private val context:Context,private val clickListener: ClickListener): RecyclerView.Adapter<GenreAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if(genre.clicked) {
            holder.button.background=ContextCompat.getDrawable(context,R.drawable.genre_design_selected)
